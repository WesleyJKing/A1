...
::: {layout-ncol=2}
![Figure 1: Number of sentences per president](eda_plots/sentence_counts.png){width=400px height=350px}

![Figure 2: Average sentence length per president](eda_plots/sentence_length.png){width=400px height=350px}
:::
...
![Figure 3: Word cloud for de Klerk](eda_plots/deklerk_wordcloud.png)

![Figure 4: Word cloud for Mandela](eda_plots/mandela_wordcloud.png)
:::
...
| ELECTRA   |  |   |       | 0.580
: Table 1: Test set accuracy for all models
...
: Table 2: Test set F1-scores for all models
...
Classify text with Bert (no date) TensorFlow. Available at: https://www.tensorflow.org/text/tutorials/classify_text_with_bert (Accessed: 17 October 2023). 

electra_base (no date) Tensorflow hub. Available at: https://tfhub.dev/google/electra_base/2 (Accessed: 14 October 2023). 

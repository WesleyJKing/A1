...
$$
\text{IDF(t)} = log_e \left( \frac{\text{Total number of sentences}} / {(\text{Number of sentences with term t in it})}\right )
$$
...
![](eda_plots/sentence_counts.png)

![](eda_plots/sentence_length.png)
:::
